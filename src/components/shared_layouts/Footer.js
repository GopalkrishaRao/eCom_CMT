          ...
          <div className="col-lg col-xl last-mobile">
            <div className="footer-block">
              ...
              <div className="collapsed-content">
                <ul>
                  <li>E-mail: <a href="mailto:codemythought.com">codemythought@gmail.com</a></li>
              ...
              <div className="d-lg-none mt-3">
                <div className="box-coupon">
                  ...
                  <div className="box-coupon-text"><span className="custom-color">CMT</span> THEME</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="footer-bottom footer-bottom--bg">
      <div className="container">
        <div className="footer-copyright text-center">
          <a href="#">Code My Thought</a> &#169; {year} All Rights Reserved
        </div>
      </div>
    </div>
  </footer>
